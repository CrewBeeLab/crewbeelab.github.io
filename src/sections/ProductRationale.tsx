...
export const ProductRationale = ({ content }: LocalizedSectionProps) => (
  <section className="py-20 md:py-28 lg:py-36 bg-paper-warm/40 border-y border-ink/5 relative overflow-hidden">
    ...
    <motion.div id="why-crewbee" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-100px' }} transition={{ duration: 0.8 }} className="anchor-target max-w-4xl mx-auto px-6 text-center relative z-10">
