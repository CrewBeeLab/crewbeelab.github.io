      ...
      <div className="lg:col-span-2 space-y-7 md:space-y-9">
        {content.faq.items.map((faq) => (
          <div key={faq.q} className="border-l-[0.5px] border-ink/20 pl-6 md:pl-8 pb-4 relative">
            ...
            <h4 className="text-xl md:text-[1.45rem] font-serif mb-3 text-ink leading-snug">{faq.q}</h4>
            <p className="text-ink/64 font-serif text-base md:text-[1.05rem] leading-[1.68]">{faq.a}</p>
          </div>
        ))}
      </div>
    </div>
