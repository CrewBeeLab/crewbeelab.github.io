  ...
  <section id="docs" className="section-container border-y border-ink/5 bg-paper-warm/20">
    <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
      <div className="lg:col-span-1">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl mb-6 md:mb-8 font-serif italic tracking-tight leading-tight">{content.faq.heading[0]} <br className="hidden lg:block" /> {content.faq.heading[1]} <br className="hidden lg:block" /> {content.faq.heading[2]}</h2>
      </div>
