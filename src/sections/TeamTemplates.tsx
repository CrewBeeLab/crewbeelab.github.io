  ...
  <section id="teams" className="bg-ink text-paper py-24 md:py-32 lg:py-48 px-6">
    <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
      <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
        ...
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif italic leading-[1.1] mb-6 md:mb-8 text-paper">{content.team.title}</h2>
        <p className="text-lg md:text-2xl font-serif text-paper/70 leading-relaxed mb-6 md:mb-8">{content.team.paragraphs[0]}</p>
        <p className="text-base md:text-lg font-serif text-paper/50 leading-relaxed">{content.team.paragraphs[1]}</p>
      </motion.div>
