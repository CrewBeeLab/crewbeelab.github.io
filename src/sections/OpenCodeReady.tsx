...
export const OpenCodeReady = ({ t }: LocalizedSectionProps) => (
  <section className="py-24 md:py-32 lg:py-48 max-w-6xl mx-auto px-6 text-center">
    ...
    <p className="text-lg md:text-2xl font-serif text-ink/70 leading-relaxed mb-10 md:mb-12 max-w-4xl mx-auto">{t.opencode.description}</p>
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-10 md:mb-12 text-left">
      {t.opencode.proofs.map((proof) => (
