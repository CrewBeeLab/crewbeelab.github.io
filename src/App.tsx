...
const SectionHeading = ({ children, badge, subtitle, centered = false }: { children: React.ReactNode, badge?: string, subtitle?: string, centered?: boolean }) => (
  <div className={`mb-20 ${centered ? 'text-center' : ''}`}>
    ...
    <h2 className="text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight font-serif italic text-ink">
      {children}
    </h2>
    {subtitle && (
      <p className="text-lg md:text-xl font-serif italic text-ink/60 max-w-2xl mx-auto md:mx-0 leading-relaxed">
        {subtitle}
      </p>
    )}
  </div>
  ...
  <section id="features" className="section-container">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
      {[
        ...
        <div key={i} className="card-paper p-10 flex flex-col items-start text-left relative overflow-hidden group">
          ...
          <span className="text-[10px] font-bold text-honey mb-8 block tracking-[0.2em] font-sans">0{i + 1}</span>
          <h3 className="text-2xl mb-4 italic font-serif leading-tight">{item.title}</h3>
          <p className="text-ink/60 font-serif leading-relaxed text-lg">{item.desc}</p>
        </div>
      ))}
    </div>
  </section>
...
const WhyItExists = () => (
  <section id="why-crewbee" className="py-32 md:py-48 bg-paper-warm/40 border-y border-ink/5 relative overflow-hidden">
    ...
    >
      <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif italic leading-[1.1] mb-12 text-ink">
...
const TeamFirstModel = () => (
  <section id="teams" className="bg-ink text-paper py-32 md:py-48 px-6">
    <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif italic leading-[1.1] mb-8 text-paper">The Team-first Model</h2>
        <p className="text-xl md:text-2xl font-serif text-paper/70 leading-relaxed mb-8">
      ...
      <motion.div 
        ...
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true }}
        className="bg-[#1a1a1a] p-12 lg:p-16 border border-white/5 shadow-2xl relative overflow-hidden group"
      >
         ...
         <div className="font-mono text-sm leading-8 text-white/80 relative z-10 space-y-2">
           <div><span className="text-honey font-bold tracking-widest text-[11px] uppercase">CodingTeam/</span></div>
           <div className="pl-6 flex items-center gap-4 hover:text-white transition-colors duration-200"><div className="w-1.5 h-px bg-honey/50" /> team.manifest.yaml</div>
           <div className="pl-6 flex items-center gap-4 hover:text-white transition-colors duration-200"><div className="w-1.5 h-px bg-honey/50" /> team.policy.yaml</div>
           <div className="pl-6 flex items-center gap-4 hover:text-white transition-colors duration-200"><div className="w-1.5 h-px bg-honey/50" /> coding-leader.agent.md</div>
           <div className="pl-6 flex items-center gap-4 hover:text-white transition-colors duration-200"><div className="w-1.5 h-px bg-honey/50" /> reviewer.agent.md</div>
           <div className="pl-6 flex items-center gap-4 hover:text-white transition-colors duration-200"><div className="w-1.5 h-px bg-honey/50" /> TEAM.md</div>
         </div>
      </motion.div>
    </div>
  </section>
...
const OpenCodeReady = () => (
  <section className="py-32 md:py-48 max-w-4xl mx-auto px-6 text-center">
    <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif italic leading-tight mb-8">Built for OpenCode first.</h2>
    <p className="text-xl md:text-2xl font-serif text-ink/70 leading-relaxed mb-12">
