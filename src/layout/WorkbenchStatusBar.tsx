...
export const WorkbenchStatusBar = ({ content }: { content: HomepageContent }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] grid grid-cols-3 items-center h-6 bg-[#050505] px-4 font-mono text-[11px] text-white/30">
      ...
      <div className="text-center">
        {content.footer.icp ? (
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="text-white/20 hover:text-white/80 transition-colors duration-200 decoration-transparent"
          >
            {content.footer.icp}
          </a>
        ) : null}
