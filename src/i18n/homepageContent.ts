export const homepageContent = {
  en: {
    ...
    hero: {
      ...
      description: 'CrewBee turns scattered prompts, agents, rules, review flows, and completion criteria into maintainable Agent Team assets that can be projected into your agent harness.',
      supporting: 'Define Teams. Pick a Leader. Project structured agent workflows into your coding agent harness. Simple tasks stay fast. Complex tasks get support, review, and completion gates.',
      boundaries: ['Harness-adaptable.', 'First adapter: OpenCode.', 'MIT Open Source.'],
    ...
    status: ['Team-first Definitions', 'Runtime Projection', 'Harness Adapter Layer', 'Delegation Tooling', 'Built-in Coding Team', 'MIT Open Source', 'First Adapter: OpenCode'],
    features: {
    ...
    how: {
      ...
      subtitle: 'Define Teams as assets, project them into the harness you use, choose the right execution strength, and close work with review and completion criteria.',
      steps: [
    ...
    firstTask: {
      ...
      subtitle: 'Today, start with the OpenCode adapter: open a project in OpenCode, select `coding-leader`, and ask CrewBee to solve a real coding task with review-backed completion.',
      prompt: 'Use CrewBee Coding Team to fix this issue with review-backed completion.\nLocate the relevant code, implement the fix, run available diagnostics, and ask reviewer to check risks before final closure.',
    ...
    projectContext: {
      badge: 'Roadmap',
      title: 'Roadmap: Project Context and more Agent Harnesses',
      subtitle: 'CrewBee keeps the Team definition and projection layer host-adaptable while moving toward better long-running project context.',
      cards: [
      ...
      flowTitle: 'Project Context Loop',
    ...
    opencode: {
      title: 'Current integration: OpenCode',
      description: 'CrewBee currently ships with an OpenCode adapter that projects Team definitions into selectable agents, binds sessions, and supports structured delegation through the plugin runtime.',
    ...
    acknowledgements: {
      ...
      paragraphs: ['Read the Quick Start, view the current OpenCode integration, or join Discussions to share your first Team.', 'CrewBee is MIT open source and designed as a harness-adaptable Agent Team asset layer.'],
  ...
  zh: {
    ...
    siteDescription: 'CrewBee 把分散在 prompts、agents、规则、review 流程和验收标准中的工作方式，整理成可维护的 Agent Team 资产，并投影到你使用的 Agent Harness 中运行。',
    nav: {
      why: '为什么需要',
      coding: 'Coding Team',
      how: '工作方式',
    ...
    hero: {
      ...
      supporting: '定义 Team，选择 Leader，把结构化 Agent 工作流投影到你使用的 Coding Agent Harness 中。简单任务保持轻量，复杂任务获得支援、review 和完成闸门。',
      boundaries: ['可适配多种 Agent Harness。', '当前首个适配宿主：OpenCode。', 'MIT 开源。'],
    ...
    status: ['Team-first 定义', 'Runtime Projection', '宿主适配层', 'Delegation Tooling', '内置 Coding Team', 'MIT 开源', '当前适配 OpenCode'],
    features: {
      title: '从分散配置，到可维护的 Agent Team。',
      subtitle: 'CrewBee 关注让 Agent 工作方式变得可维护、可迁移的核心结构：Team 资产、执行强度、决策上下文和上下文隔离式委派。',
      cards: [
    ...
    how: {
      title: 'CrewBee 如何工作',
      subtitle: '把 Team 定义成资产，投影到你使用的宿主，根据任务复杂度选择执行强度，并通过 review 与验收标准完成收口。',
      steps: [
    ...
    firstTask: {
      ...
      subtitle: '当前可以先从 OpenCode 适配器开始：在 OpenCode 中打开一个项目，选择 `coding-leader`，让 CrewBee 使用 review-backed completion 完成一个真实代码任务。',
      prompt: '使用 CrewBee Coding Team 修复这个问题，并在完成前进行独立 review 和验收标准检查。\n请先定位相关代码，再实现修复，运行可用的 diagnostics，并在最终收口前让 reviewer 检查风险。',
    ...
    projectContext: {
      badge: 'Roadmap',
      title: 'Roadmap：Project Context 与更多 Agent Harness',
      subtitle: 'CrewBee 的 Team 定义与投影层会尽量保持宿主可适配，同时继续增强面向长期项目的上下文能力。',
      cards: [
    ...
    opencode: {
      title: '当前集成：OpenCode',
      description: 'CrewBee 当前提供 OpenCode adapter，可以把 Team 定义投影成可选择的 Agent，并通过插件运行时支持 session binding 与结构化委派。',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'CrewBee 和 oh-my-openagent 有什么不同？', a: 'oh-my-openagent 更像增强 OpenCode 的重型 agent harness，提供大量执行增强能力。CrewBee 更像 Team definition and projection layer：把 prompts、agents、rules、review flows 和 completion criteria 整理成可维护的 Team 资产，并投影到不同 Agent Harness 中运行。OpenCode 是当前第一个支持的宿主。' },
    ...
    acknowledgements: {
      ...
      paragraphs: ['阅读快速开始，查看当前 OpenCode 集成，或者加入 Discussions 展示你的第一支 Team。', 'CrewBee 是 MIT 开源项目，定位是可适配不同 Agent Harness 的 Agent Team 资产层。'],
